...
if __name__ == '__main__':
    # os.system('bash ./kill_ps.sh')  # may need manually kill battery script
    ...
    if id_adb == '' or id_adb is None:
        print('No id , exit !!!')
        # os.system('bash ./kill_ps.sh')  # keep batter script manually
        print('you can kill battery script now')
        exit(1)

    remove_appium(id_adb)

    # os.system('bash appium_start.sh')   # G6 automation may have it running already
    # sleep(20)
